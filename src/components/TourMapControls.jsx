...
export default function TourMapControls({ mapMode, setMapMode, mapDisplay, setMapDisplay, selectedArtist, setSelectedArtist, artists }) {
  ...
  return (
    <div className="absolute top-4 left-4 right-4 z-20 grid grid-cols-[repeat(4,minmax(0,1fr))] items-stretch gap-1.5 sm:right-auto sm:w-[368px] sm:grid-cols-4 sm:gap-2">
