...
export default function TourMapControls({ mapMode, setMapMode, mapDisplay, setMapDisplay, selectedArtist, setSelectedArtist, artists }) {
  ...
  return (
    <div className="absolute top-4 left-4 right-4 z-20 grid grid-cols-4 items-stretch gap-1.5 sm:flex sm:w-auto sm:right-auto sm:gap-2">
      <div className="min-h-14 bg-[#0B0F19]/90 backdrop-blur border border-slate-800 p-2 rounded-xl shadow-lg sm:p-3">
