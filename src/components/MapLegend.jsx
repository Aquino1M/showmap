export default function MapLegend() {
  return (
    <div className="pointer-events-none absolute bottom-[7rem] left-1/2 z-[500] flex w-[min(calc(100%-2rem),360px)] -translate-x-1/2 items-center justify-center gap-2 rounded-xl border border-slate-700 bg-[#0B0F19]/95 px-3 py-2.5 text-[9px] text-slate-200 shadow-xl backdrop-blur sm:bottom-4 sm:left-auto sm:right-4 sm:block sm:w-auto sm:max-w-none sm:translate-x-0 sm:text-[10px]">
